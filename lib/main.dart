...
import 'package:test_map/src/ui/app/app_page.dart';

import 'direction_model.dart';
import 'direction_repository.dart';
import 'src/domain/repository/base.dart';

void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  await Firebase.initializeApp();
  GetIt.I.registerSingleton(await Storage().init());
  GetIt.I.registerSingleton(await FirebaseStorageService().init());
  GetIt.I.registerSingleton(await Api().init());
